...
namespace FaiyazIslamLab5.Models
{
    public class DBConnect
    {
        ...
        string SqlConnectString = "server=cis-mssql1.temple.edu;Database=fa22_3344_tuk45258;User id=tuk45258;Password=****";

        // Home Connection String - used for working from home using SSH Tunneling.
        //String SqlConnectString = "server=127.0.0.1,5555;Database=fa22_3344_tuk45258;User id=tuk45258;Password=****";
